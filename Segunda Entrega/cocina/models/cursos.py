...
class Cursos(models.Model):
     ...
     fechaInicio = fields.Datetime('Fecha inicio',required=False, help="Fecha de inicio de nuestro curso")
     fechaFin = fields.Datetime('Fecha fin',required=False, help="Fecha de finalizacion de nuestro curso")
